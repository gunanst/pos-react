    ...
    return (
        <>
            ...
            <Modal isOpen={open} onCloseAction={() => setOpen(false)}>
                ...
                >
                    <input name="name" defaultValue={product.name} className="border px-2 py-1" required />
                    <input type="number" name="price" defaultValue={product.price} className="border px-2 py-1" required />
                    <input type="number" name="stock" defaultValue={product.stock} className="border px-2 py-1" required />
